...
// 			if (!existingOtp) {
// 				isUnique = true; // Exit loop if OTP is unique
// 			}
// 		}

// 		// Save OTP to DB with expiration time (10 minutes)
// 		const otpPayload = { email, otp, createdAt: Date.now(), expiresAt: Date.now() + 10 * 60 * 1000 };
...
// 		// 		html: `<p>Your OTP for verification is: <strong>${otp}</strong></p><p>This OTP will expire in 10 minutes.</p>`,
// 		// 	};
